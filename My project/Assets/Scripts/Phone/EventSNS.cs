...
public class EventSNS : MonoBehaviour
{
    ...
    public void OnEnable()
    {
        ...
        if (Phone.activeSelf)
        {
            ...
            if (playActions.transform.GetChild(6).gameObject.transform.GetChild(0).gameObject.activeSelf)
            {   
                ...
                {
                    Phone.transform.GetChild(0).transform.GetChild(0).gameObject.SetActive(true);
                }
                if (playActions.transform.GetChild(1).gameObject.activeSelf)
                {
                    Phone.transform.GetChild(1).transform.GetChild(0).gameObject.SetActive(true);
                }
                play.sns = false;
            }
        }
